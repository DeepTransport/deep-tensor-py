...
## TODO:
 ...
 - Figure out what an appropriate amount of noise is for the likelihood function (see Pash et al.)? It seems reasonable to define this relative to the range of the observations (I think a value of 2% is used in Pash et al.)