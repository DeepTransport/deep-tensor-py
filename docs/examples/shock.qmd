...
For all parameters, the integrated autocorrelation time (IACT) is small, which suggests that the sampler is moving around the posterior efficiently.

@fig-pairs shows a set of prior and posterior samples.
