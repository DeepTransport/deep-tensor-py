...
<code>[**Q**]{.parameter-name} [:]{.parameter-annotation-sep} [Callable\[\[Tensor, str\], Tensor\]]{.parameter-annotation}</code>
...
<code>[**Q_inv**]{.parameter-name} [:]{.parameter-annotation-sep} [Callable\[\[Tensor, str\], Tensor\]]{.parameter-annotation}</code>
...
<code>[**neglogdet_Q**]{.parameter-name} [:]{.parameter-annotation-sep} [Callable\[\[Tensor, str\], Tensor\]]{.parameter-annotation}</code>
...
<code>[**neglogdet_Q_inv**]{.parameter-name} [:]{.parameter-annotation-sep} [Callable\[\[Tensor, str\], Tensor\]]{.parameter-annotation}</code>
