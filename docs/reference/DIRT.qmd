...
<code>[**negloglik**]{.parameter-name} [:]{.parameter-annotation-sep} [Callable\[\[Tensor\], Tensor\]]{.parameter-annotation}</code>
...
<code>[**neglogpri**]{.parameter-name} [:]{.parameter-annotation-sep} [Callable\[\[Tensor\], Tensor\]]{.parameter-annotation}</code>
...
<code>[**tt_options**]{.parameter-name} [:]{.parameter-annotation-sep} [TTOptions \| None]{.parameter-annotation} [ = ]{.parameter-default-sep} [None]{.parameter-default}</code>
...
<code>[**dirt_options**]{.parameter-name} [:]{.parameter-annotation-sep} [DIRTOptions \| None]{.parameter-annotation} [ = ]{.parameter-default-sep} [None]{.parameter-default}</code>

:   Options for constructing the DIRT approximation to the  target density.

<code>[**prev_approx**]{.parameter-name} [:]{.parameter-annotation-sep} [Dict\[int, SIRT\] \| None]{.parameter-annotation} [ = ]{.parameter-default-sep} [None]{.parameter-default}</code>
