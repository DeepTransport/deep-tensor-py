...
<code>[**betas**]{.parameter-name} [:]{.parameter-annotation-sep} [List \| Tensor \| None]{.parameter-annotation} [ = ]{.parameter-default-sep} [None]{.parameter-default}</code>

:   A set of $\beta$ values to use for the intermediate  distributions. If not specified, these will be determined  automatically.

<code>[**ess_tol**]{.parameter-name} [:]{.parameter-annotation-sep} [float]{.parameter-annotation} [ = ]{.parameter-default-sep} [0.5]{.parameter-default}</code>
...
<code>[**ess_tol_init**]{.parameter-name} [:]{.parameter-annotation-sep} [float]{.parameter-annotation} [ = ]{.parameter-default-sep} [0.5]{.parameter-default}</code>
...
<code>[**beta_factor**]{.parameter-name} [:]{.parameter-annotation-sep} [float]{.parameter-annotation} [ = ]{.parameter-default-sep} [1.05]{.parameter-default}</code>
...
<code>[**min_beta**]{.parameter-name} [:]{.parameter-annotation-sep} [float]{.parameter-annotation} [ = ]{.parameter-default-sep} [0.0001]{.parameter-default}</code>
