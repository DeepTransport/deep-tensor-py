...
from examples.double_banana.double_banana import ConditionalBanana


sigma = 0.3
model = ConditionalBanana(sigma)


dom = dt.BoundedDomain(bounds=torch.tensor([-5., 5.]))
diag = dt.GaussianReference(0, 1, dom)
